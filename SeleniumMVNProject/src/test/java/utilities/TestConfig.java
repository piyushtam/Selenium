...
//DB URL username password - Read only select
	...
	public static String from = "pyush1811@gmail.com";
	public static String password = "pyush$1811";
	public static String[] to ={"piyushtamrakar93@gmail.com"};
	public static String subject = "Test Report";
	
	public static String messageBody ="TestMessage";
	public static String attachmentPath="C:\\Users\\vpn_inspop\\Desktop\\sun.jpg";
